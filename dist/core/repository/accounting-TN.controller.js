...
exports.AccountingControllerTN = void 0;
...
class AccountingControllerTN {
    ...
    getOneAdvert(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const Item = yield accounting_TN_model_1.default.find({
                    _id: req.params.id,
                });
                res.json(Item);
            }
    ...
    deleteAdvert(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const Item = yield accounting_TN_model_1.default.deleteOne({
                    _id: req.params.id,
                });
    ...
    updateAdvert(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const Item = yield accounting_TN_model_1.default.findOneAndUpdate({
                    _id: req.params.id,
                }, {
                    id: id,
                    type: type,
...
exports.AccountingControllerTN = AccountingControllerTN;
